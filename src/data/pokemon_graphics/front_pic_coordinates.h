...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_DARTRIX]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_DECIDUEYE]   = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_LITTEN]      = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  8 },
    [SPECIES_TORRACAT]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_INCINEROAR]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_POPPLIO]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 12 },
