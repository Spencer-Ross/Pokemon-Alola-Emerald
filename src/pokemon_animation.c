...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_ROWLET]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_DARTRIX]    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DECIDUEYE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_LITTEN]     = BACK_ANIM_H_SLIDE,
    [SPECIES_TORRACAT]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_INCINEROAR] = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_POPPLIO]    = BACK_ANIM_H_SLIDE,
    [SPECIES_BRIONNE]    = BACK_ANIM_CONCAVE_ARC_SMALL,
