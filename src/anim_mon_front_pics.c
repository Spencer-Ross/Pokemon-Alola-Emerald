...
const u32 gMonFrontPic_Torracat[] = INCBIN_U32("graphics/pokemon/torracat/anim_front.4bpp.lz");
const u32 gMonFrontPic_Incineroar[] = INCBIN_U32("graphics/pokemon/incineroar/anim_front.4bpp.lz");
