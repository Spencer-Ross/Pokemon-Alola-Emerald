...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_DARTRIX - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DECIDUEYE - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    ...
    [SPECIES_LITTEN - 1]      = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_TORRACAT - 1]    = ANIM_V_SLIDE,
    [SPECIES_INCINEROAR - 1]  = ANIM_V_JUMPS_BIG,
